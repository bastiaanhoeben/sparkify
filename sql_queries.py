...
songplay_id SERIAL PRIMARY KEY, start_time TIMESTAMP NOT NULL REFERENCES time, 
user_id INT NOT NULL REFERENCES users(user_id), level VARCHAR, 
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs (song_id 
VARCHAR PRIMARY KEY, title VARCHAR, artist_id VARCHAR, year INT, duration 
FLOAT)""")

artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists
(artist_id VARCHAR PRIMARY KEY, name VARCHAR, location VARCHAR, latitude FLOAT, 
longitude FLOAT)""")

time_table_create = ("""CREATE TABLE IF NOT EXISTS time
(start_time TIMESTAMP PRIMARY KEY, hour INT, day VARCHAR, week INT, month INT, 
...
latitude, longitude) VALUES (%s, %s, %s, %s, %s) ON CONFLICT (artist_id) DO 
NOTHING""")
